...
// // //     vec3 tmin = min(max_intervals, min_intervals);
// // //     vec3 tmax = max(max_intervals, min_intervals);

// // //     float dstA = max(max(tmin.x, tmin.y), tmin.z);
// // //     float dstB = min(tmax.x, min(tmax.y, tmax.z));

// // //     ret_info.distToBox = max(0, dstA);
// // //     ret_info.distInsideBox = max(0, dstB - ret_info.distToBox);
// // //     return ret_info;
// // // }
...
// // //     float densityGrad = getDensityForCloud(heighFraction, weatherData.r );
...
// // //         p += r.dir * stepSize;
// // //     }
// // //     float trans = exp(-totalDensity * SIGMA);
// // //     return trans;
...
// // // // float getWorldSpaceDepth(float depth){
// // // //     float z = depth * 2.0 - 1.0;
// // // //     vec4 clipSpacePosition = vec4(tCoord * 2.0 - 1.0, z, 1.0);
...
// // // //     return length(worldSpacePosition.xyz - camPos);
// // // // }

// // // uniform float HG = 0.3;
...
// // //     vec3 col = vec3(0.0);
// // //     float distToGo = min(info.distInsideBox, depth - info.distToBox);
// // //     // float distToGo = info.distInsideBox;
// // //     float t = 0.0;
...
// // //     float worldDepth = length(worldSpacePosition.xyz - camPos);

// // //     // float linearDepth = linearizeDepth(depth);
// // //     // // Convert to world space distance along ray direction
// // //     // float worldDepth =  linearDepth / dot(rayDir, normalize(-vec3(invViewMat[2].xyz)));
...
// // //         color.xyz = col;
// // //     }
// // //     vec3 res = rayMarch(r, color.xyz, color, depth);
// // //     // fcol = vec4(res, 1.0);
// // //     // vec3 res = vec3(min(info.distInsideBox, linearizeDepth(depth))/50);
// // //     // vec3 res = vec3(min(info.distInsideBox/400, worldDepth/50));
...
// //         finalCloud = remap(finalCloud, highModifier*0.2, 1.0, 0.0, 1.0);
// //     }
// //     return clamp(finalCloud, 0., 1.) * densityMultiplier;
// // }



// // uniform float SIGMA = 0.05f;
...
// //     _box_intersect_info info = rayIntersectsBox(r, bounding_rect);
// //     depth = linearizeDepth(depth);
// //     float totalDist = min(depth, info.distInsideBox);
// //     float stepSize = totalDist / MAX_STEPS;
// //     vec3 p = r.pos + r.dir * info.distToBox;
// //     vec3 col = vec3(0.0);
...
//     baseCloud = max(baseCloud-densityThreshold, 0.);
//     vec3 weatherData = getWeatherData(p);
//     float densityGrad = getDensityForCloud(heighFraction, .2);
//     baseCloud *= densityGrad;
...
//     _box_intersect_info info = rayIntersectsBox(r, bounding_rect);
//     depth = linearizeDepth(depth);
//     float stepSize = min(depth, info.distInsideBox) / MAX_STEPS;
//     vec3 p = r.pos + r.dir * info.distToBox;
//     vec3 col = vec3(0.0);
